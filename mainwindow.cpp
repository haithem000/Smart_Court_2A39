...
void MainWindow::on_statbouton_clicked()
{
    QSqlQuery query,query1,query2,query3;
                ...
                query.prepare("SELECT * FROM CITOYEN") ;
                query.exec();
                while(query.next())
                {
                        sum++ ;
                ...
                query1.prepare("SELECT * FROM CITOYEN where AGE >25 and age<35") ;
                query1.exec();
                while(query1.next())
                {
                        c1++ ;
                ...
                query2.prepare("SELECT * FROM CITOYEN where AGE >35 and age<45 ") ;
                query2.exec();
                while(query2.next())
                {
                        c2++ ;
                ...
                query3.prepare("SELECT * FROM CITOYEN where AGE >45") ;
                query3.exec();
                while(query3.next())
                {
                        c3++ ;
    ...
    if(data == "0"){
        ...
        QSqlQuery query,query1;
             ...
             while(query.next()){
                 dateRDV = query.value(3).toString();
                 if(query.value(9).toInt() == 0){
                     query1.prepare("update TABLE1 set ETAT =:ETAT where NUMR=:NUMR");
                     query1.bindValue(":ETAT","1");
                     query1.bindValue(":NUMR", DataAsString);
                     query1.exec();
